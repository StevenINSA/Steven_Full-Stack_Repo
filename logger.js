...
// Let's create a Logger class
class Logger extends EventEmitter {
    log(msg) {

        //Call event
        //As we extended Logger to EventEmitter, it includes the function emit
        this.emit('event_message', { id: uuid.v4(), message: msg }); // So everytime we call 'log', it will show a new id with the msg that is sent
    }
}
